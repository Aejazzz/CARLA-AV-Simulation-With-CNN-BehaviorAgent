...
|--------|----------|---------------|
| **Matplotlib realtime dashboard** | Representative layout (same panels as live client) | [`examples/project_docs/figures/dashboard_matplotlib.png`](./examples/project_docs/figures/dashboard_matplotlib.png) |
| **Pygame HUD** | Representative dark-theme HUD typography — swap for a live capture if needed | [`examples/project_docs/figures/pygame_hud.png`](./examples/project_docs/figures/pygame_hud.png) |
| **Training / validation curves** | **Measured** PilotNet curves from `bc_training_history.csv` | [`examples/models/bc_training_curves.png`](./examples/models/bc_training_curves.png) |
...
To replace with exact in-sim screenshots, overwrite these PNG paths.
